import type { ClientHandle, CommandExecutionFailure, EngineId } from './control-protocol.js';
...
export interface ControlWorkerCommandContext {
    ...
    readonly toCommandError: (error: unknown, fallbackMessage: string) => CommandExecutionFailure['error'];
}
//# sourceMappingURL=control-worker-command-context.d.ts.map