...
import type { CoordinateBasisOption, ExecutionMode, QualityTier, ThreadOption, Throughput } from './facade.js';
...
export interface ExaSoundModule {
    ...
    ccall?: (ident: string, returnType: string | null, argTypes: string[], args: unknown[], opts?: {
        async?: boolean;
    }) => unknown;
    cwrap?: <R, A extends unknown[]>(ident: string, returnType: string | null, argTypes: readonly (string | null)[]) => (...args: A) => R;
