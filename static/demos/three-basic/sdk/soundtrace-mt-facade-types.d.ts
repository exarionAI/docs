import type { DebugSnapshot, DebugSnapshotOptions, ControlCommand } from './control-protocol.js';
import type { AudioOption, Vec3 } from './native/index.js';
import type { QualityTier, SourcePathType } from './facade.js';
import type { DelayInterpolation, DiffuseQuality, HrtfQuality, LateReverbMode } from './SoundListener.js';
export interface MtFacadeClient {
    command(command: ControlCommand): Promise<unknown>;
    frame(dt: number): Promise<{
...
//# sourceMappingURL=soundtrace-mt-facade-types.d.ts.map