...
// ST mode renders on the main thread with SoundListener.render(). When
// SharedArrayBuffer is available, this small worklet drains the rendered
// interleaved stereo ring on the audio thread.
