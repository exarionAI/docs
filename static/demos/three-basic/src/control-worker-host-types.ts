...
import type {
  ListenerTransformHotLane,
  ListenerTransformPayload,
} from './control-hot-listener-transform.js';
import type {
  MeshTransformHotLane,
  MeshTransformPayload,
} from './control-hot-mesh-transform.js';
import type {
  SourceTransformHotLane,
  SourceTransformPayload,
...
export type DeleteSourceOperation = (
  command: CommandDeleteSource & { readonly engineId: EngineId },
) => Promise<unknown>;
export type DeleteMeshOperation = (
  command: CommandDeleteMesh & { readonly engineId: EngineId },
) => Promise<unknown>;
export type SetMeshMaterialOperation = (
  command: CommandSetMeshMaterial & { readonly engineId: EngineId },
) => Promise<unknown>;
export type SetMeshMaterialRangeOperation = (
  command: CommandSetMeshMaterialRange & { readonly engineId: EngineId },
) => Promise<unknown>;
export type SetMeshUpdateTypeOperation = (
  command: CommandSetMeshUpdateType & { readonly engineId: EngineId },
) => Promise<unknown>;
export type SetSourceParamOperation = (
  command: CommandSetSourceParam & { readonly engineId: EngineId },
) => Promise<unknown>;
export type SetRenderOptionOperation = (
  command: CommandSetRenderOption & { readonly engineId: EngineId },
) => Promise<unknown>;
export type SetListenerOptionOperation = (
  command: CommandSetListenerOption,
) => Promise<unknown>;
export type ApplyHotListenerTransformOperation = (
  command: ListenerTransformPayload,
) => unknown | Promise<unknown>;
export type ApplyHotMeshTransformOperation = (
  command: MeshTransformPayload & { readonly engineId: EngineId },
) => unknown | Promise<unknown>;
export type ApplyHotSourceTransformOperation = (
  command: SourceTransformPayload & { readonly engineId: EngineId },
) => unknown | Promise<unknown>;
...
export type CreateModule = (
  glueUrl: string,
  moduleArg: Partial<ExaSoundModule>,
) => Promise<ExaSoundModule>;
...
export type ControlWorkerHostInitOptions =
  | Partial<ControlWorkerDependencies>
  | { readonly dependencies?: Partial<ControlWorkerDependencies> };

export function getDependenciesFromOptions(
  options: ControlWorkerHostInitOptions,
): Partial<ControlWorkerDependencies> | undefined {
...
function hasDependencyEnvelope(
  options: ControlWorkerHostInitOptions,
): options is { readonly dependencies?: Partial<ControlWorkerDependencies> } {
