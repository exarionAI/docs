...
export type RemovedTransformCommand =
  | RemovedMeshTransformCommand
  | RemovedListenerTransformCommand;
...
export type ControlResponseByRequestKind<K extends ControlRequest['kind']> =
  K extends 'init' ? ReadyResponse
  : K extends 'command' ? ResultResponse
  : K extends 'frame' ? FrameResultResponse
  : K extends 'debugSnapshot' ? DebugSnapshotResponse
  : K extends 'dispose' ? ResultResponse
  : never;
