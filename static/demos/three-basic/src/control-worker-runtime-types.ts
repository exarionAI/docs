import type {
  ...
  CommandStartAudioSource,
  CommandStopAudioSource,
  DebugSnapshot,
...
export interface ControlWorkerRuntime {
  ...
  readonly deleteSource?: (command: CommandDeleteSource & { readonly engineId: number }) => unknown | Promise<unknown>;
  readonly deleteMesh?: (command: CommandDeleteMesh & { readonly engineId: number }) => unknown | Promise<unknown>;
  readonly setMeshMaterial?: (command: CommandSetMeshMaterial & { readonly engineId: number }) => unknown | Promise<unknown>;
  ...
  readonly setSourceParam?: (command: CommandSetSourceParam & { readonly engineId: number }) => unknown | Promise<unknown>;
  readonly startAudioSource?: (command: CommandStartAudioSource & { readonly engineId: number }) => unknown | Promise<unknown>;
  readonly stopAudioSource?: (command: CommandStopAudioSource) => unknown | Promise<unknown>;
  readonly setRenderOption?: (command: CommandSetRenderOption & { readonly engineId: number }) => unknown | Promise<unknown>;
