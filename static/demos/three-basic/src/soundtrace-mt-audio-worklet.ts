import {
  MT_AUDIO_BLOCK_FRAMES,
  MT_AUDIO_RING_CAPACITY_FRAMES,
  MT_AUDIO_RING_STATE_LENGTH,
  MT_AUDIO_RING_STATE_READ_INDEX,
  MT_AUDIO_RING_STATE_WRITE_INDEX,
} from './soundtrace-mt-audio-shared.js';

export const MT_AUDIO_WORKLET_PROCESSOR_NAME = 'soundtrace-mt-audio-bridge';

export function createMtAudioWorkletModuleSource(
  processorName: string = MT_AUDIO_WORKLET_PROCESSOR_NAME,
): string {
  return `
