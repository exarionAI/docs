...
function resolveDocumentBaseHref(): string | null {
...
export function resolveControlWorkerCoreBaseUrl(coreBaseUrl: string): string {
...
export function createControlWorkerBootstrapSource(moduleUrl: string): string {
...
export function createControlWorkerBootstrapUrl(moduleUrl: string): string {
  ...
  return URL.createObjectURL(
    new Blob(
      [createControlWorkerBootstrapSource(moduleUrl)],
      { type: 'text/javascript' },
    ),
  );
}

export function releaseControlWorkerBootstrapUrl(url: string): void {
