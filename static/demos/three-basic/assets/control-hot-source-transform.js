...
function ensureFloatTuple(value, label) {
...
export function createSourceTransformHotLane(capacity) {
...
export function createSourceTransformReadCursor(capacity) {
    ensureValidCapacity(capacity);
    return {
        seen: new Int32Array(capacity),
    };
}
export function writeSourceTransformHotSlot(lane, slot, payload) {
...
export function readChangedSourceTransforms(lane, cursor) {
...
//# sourceMappingURL=control-hot-source-transform.js.map